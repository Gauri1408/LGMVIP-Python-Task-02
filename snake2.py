...
snake_head.color("#0000FF")  # Blue for snake head
snake_head.penup()
snake_head.goto(0, 0)
...
snake_food.color("#FF0000")  # Red for snake food
snake_food.penup()
...
pen.speed(0)
pen.shape("square")
pen.color("#FFFFFF")  # White for score display
pen.penup()
pen.hideturtle()
pen.goto(0, 260)
...
while True:
    ...
    if snake_head.distance(snake_food) < 20:
        ...
        new_segment.color("#0000FF")  # Blue for snake body
        new_segment.penup()
